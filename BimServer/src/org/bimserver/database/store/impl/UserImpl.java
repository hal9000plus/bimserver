 ...
 * <ul>
 *   <li>{@link org.bimserver.database.store.impl.UserImpl#getId <em>Id</em>}</li>
...
public class UserImpl extends EObjectImpl implements User {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StorePackage.USER__ID, oldId, id));
	}
