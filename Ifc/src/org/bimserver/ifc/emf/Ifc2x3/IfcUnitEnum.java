...
public enum IfcUnitEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcUnitEnum[] VALUES_ARRAY = new IfcUnitEnum[] { NULL, ELECTRICRESISTANCEUNIT, ELECTRICCURRENTUNIT, ILLUMINANCEUNIT, FREQUENCYUNIT,
			AREAUNIT, TIMEUNIT, ELECTRICCHARGEUNIT, FORCEUNIT, LENGTHUNIT, RADIOACTIVITYUNIT, DOSEEQUIVALENTUNIT, INDUCTANCEUNIT, MAGNETICFLUXDENSITYUNIT,
