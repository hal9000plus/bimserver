 ...
 * @generated
 */
public class IfcConstraintAggregationRelationshipImpl extends IfcRootObject implements IfcConstraintAggregationRelationship {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public IfcLabel getName() {
		return (IfcLabel) eGet(Ifc2x3Package.eINSTANCE.getIfcConstraintAggregationRelationship_Name(), true);
	}
	...
	public IfcText getDescription() {
		return (IfcText) eGet(Ifc2x3Package.eINSTANCE.getIfcConstraintAggregationRelationship_Description(), true);
	}
