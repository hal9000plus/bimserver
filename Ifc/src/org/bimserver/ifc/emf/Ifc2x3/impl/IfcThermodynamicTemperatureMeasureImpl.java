 ...
 *   <li>{@link org.bimserver.ifc.emf.Ifc2x3.impl.IfcThermodynamicTemperatureMeasureImpl#getStringValuewrappedValue <em>String Valuewrapped Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcThermodynamicTemperatureMeasureImpl extends WrappedValueImpl implements IfcThermodynamicTemperatureMeasure {
	...
	public String getStringValuewrappedValue() {
		return (String) eGet(Ifc2x3Package.eINSTANCE.getIfcThermodynamicTemperatureMeasure_StringValuewrappedValue(), true);
	}
	...
	public void setStringValuewrappedValue(String newStringValuewrappedValue) {
		eSet(Ifc2x3Package.eINSTANCE.getIfcThermodynamicTemperatureMeasure_StringValuewrappedValue(), newStringValuewrappedValue);
	}
