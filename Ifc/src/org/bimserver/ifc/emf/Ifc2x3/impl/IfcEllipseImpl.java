...
public class IfcEllipseImpl extends IfcConicImpl implements IfcEllipse {
	...
	public IfcPositiveLengthMeasure getSemiAxis1() {
		return (IfcPositiveLengthMeasure) eGet(Ifc2x3Package.eINSTANCE.getIfcEllipse_SemiAxis1(), true);
	}
	...
	public IfcPositiveLengthMeasure getSemiAxis2() {
		return (IfcPositiveLengthMeasure) eGet(Ifc2x3Package.eINSTANCE.getIfcEllipse_SemiAxis2(), true);
	}
