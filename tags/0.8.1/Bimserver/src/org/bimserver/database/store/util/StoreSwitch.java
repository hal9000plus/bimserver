...
public class StoreSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StorePackage.CONCRETE_REVISION: {
				...
				if (result == null) result = caseRevision(concreteRevision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.VIRTUAL_REVISION: {
				VirtualRevision virtualRevision = (VirtualRevision)theEObject;
				T result = caseVirtualRevision(virtualRevision);
				if (result == null) result = caseRevision(virtualRevision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Revision</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Revision</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualRevision(VirtualRevision object) {
		return null;
	}
