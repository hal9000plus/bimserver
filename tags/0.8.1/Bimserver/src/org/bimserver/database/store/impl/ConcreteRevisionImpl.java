 ...
 * <ul>
 *   <li>{@link org.bimserver.database.store.impl.ConcreteRevisionImpl#getUser <em>User</em>}</li>
 *   <li>{@link org.bimserver.database.store.impl.ConcreteRevisionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.bimserver.database.store.impl.ConcreteRevisionImpl#getComment <em>Comment</em>}</li>
 ...
 * @generated
 */
public class ConcreteRevisionImpl extends RevisionImpl implements ConcreteRevision {
	/**
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StorePackage.CONCRETE_REVISION__COMMENT, oldComment, comment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StorePackage.CONCRETE_REVISION__DATE:
				return getDate();
			case StorePackage.CONCRETE_REVISION__COMMENT:
				return getComment();
