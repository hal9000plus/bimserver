	...
	if (loginManager.isLoggedIn()) {
		if (request.getParameter("save") != null) {
			try {
				...
				if (request.getParameter("parentid") != null) {
					response.sendRedirect("project.jsp?pid=" + request.getParameter("parentid"));
				} else {
					response.sendRedirect("project.jsp?pid=" + projectId);
				}
...
<%@page import="org.bimserver.JspHelper"%><h1>Add project</h1>
<div id="guide">
 <div id="guidewrap">
  <ol id="breadcrumb">
        <li id="bc-home">
            ...
            <li>
                <%
                	if (request.getParameter("parentid") != null) {
	                	out.append(JspHelper.generateBreadCrumbPath(loginManager.getService().getProjectById(Integer.parseInt(request.getParameter("parentid"))), loginManager.getService()));
                	}
                %>
            </li>
    </ol>
