 ...
 *   <li>{@link org.bimserver.ifc.emf.Ifc2x3.impl.IfcIonConcentrationMeasureImpl#getStringValuewrappedValue <em>String Valuewrapped Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcIonConcentrationMeasureImpl extends WrappedValueImpl implements IfcIonConcentrationMeasure {
	...
	public String getStringValuewrappedValue() {
		return (String) eGet(Ifc2x3Package.eINSTANCE.getIfcIonConcentrationMeasure_StringValuewrappedValue(), true);
	}
	...
	public void setStringValuewrappedValue(String newStringValuewrappedValue) {
		eSet(Ifc2x3Package.eINSTANCE.getIfcIonConcentrationMeasure_StringValuewrappedValue(), newStringValuewrappedValue);
	}
