 ...
 *   <li>{@link org.bimserver.ifc.emf.Ifc2x3.impl.IfcFrequencyMeasureImpl#getStringValuewrappedValue <em>String Valuewrapped Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcFrequencyMeasureImpl extends WrappedValueImpl implements IfcFrequencyMeasure {
	...
	public String getStringValuewrappedValue() {
		return (String) eGet(Ifc2x3Package.eINSTANCE.getIfcFrequencyMeasure_StringValuewrappedValue(), true);
	}
	...
	public void setStringValuewrappedValue(String newStringValuewrappedValue) {
		eSet(Ifc2x3Package.eINSTANCE.getIfcFrequencyMeasure_StringValuewrappedValue(), newStringValuewrappedValue);
	}
