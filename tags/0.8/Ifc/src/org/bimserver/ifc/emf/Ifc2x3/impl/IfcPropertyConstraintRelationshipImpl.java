 ...
 * @generated
 */
public class IfcPropertyConstraintRelationshipImpl extends IfcRootObject implements IfcPropertyConstraintRelationship {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public IfcLabel getName() {
		return (IfcLabel) eGet(Ifc2x3Package.eINSTANCE.getIfcPropertyConstraintRelationship_Name(), true);
	}
	...
	public IfcText getDescription() {
		return (IfcText) eGet(Ifc2x3Package.eINSTANCE.getIfcPropertyConstraintRelationship_Description(), true);
	}
