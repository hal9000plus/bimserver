...
public interface ServiceInterface {
	...
	boolean deleteUser(Token token, int actingUid, int uid) throws UserException;
	...
	CompareResult compare(Token token, int pid, int uid, int rid1, int rid2) throws UserException;
