...
public class KmzSerializer extends BimModelSerializer {
	...
	public KmzSerializer(EmfModel<Long> model, SchemaDefinition schemaDefinition, FieldIgnoreMap fieldIgnoreMap, FailSafeIfcEngine ifcEngine) {
		super(model, fieldIgnoreMap);
		ifcToCollada = new IfcToCollada(model, schemaDefinition, fieldIgnoreMap, ifcEngine);
	}
