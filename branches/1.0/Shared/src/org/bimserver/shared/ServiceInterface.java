...
public interface ServiceInterface {
	...
	boolean login(@QueryParam("username") @WebParam(name = "username", partName = "login.username") String username,
			@QueryParam("password") @WebParam(name = "password", partName = "login.password") String password) throws UserException, ServerException;

	@WebMethod(action = "autologin")
	boolean autologin(@WebParam(name = "username", partName = "autologin.username") String username, @WebParam(name = "hash", partName = "autologin.hash") String hash)
	...
	SCheckoutResult checkout(@WebParam(name = "roid", partName = "checkout.roid") long roid, @WebParam(name = "resultType", partName = "checkout.resultType") ResultType resultType)
			throws UserException, ServerException;
	...
	SCheckoutResult checkoutLastRevision(@QueryParam("poid") @WebParam(name = "poid", partName = "checkoutLastRevision.poid") long poid,
			@QueryParam("resultType") @WebParam(name = "resultType", partName = "checkoutLastRevision.resultType") ResultType resultType) throws UserException, ServerException;
	...
	SDownloadResult download(@QueryParam("roid") @WebParam(name = "roid", partName = "download.roid") long roid,
			@QueryParam("resultType") @WebParam(name = "resultType", partName = "download.resultType") ResultType resultType) throws UserException, ServerException;
	...
	SDownloadResult downloadByOids(@WebParam(name = "roids", partName = "downloadByOids.roids") Set<Long> roids,
			@WebParam(name = "oids", partName = "downloadByOids.oids") Set<Long> oids, @WebParam(name = "resultType", partName = "downloadByOids.resultType") ResultType resultType)
			throws UserException, ServerException;
	...
	SDownloadResult downloadProjects(@WebParam(name = "roids", partName = "downloadProjects.roids") Set<Long> roids,
			@WebParam(name = "resultType", partName = "downloadProjects.resultType") ResultType resultType) throws UserException, ServerException;

	@WebMethod(action = "addUser")
	long addUser(@WebParam(name = "username", partName = "addUser.username") String username, @WebParam(name = "name", partName = "addUser.name") String name,
			@WebParam(name = "type", partName = "addUser.type") SUserType type, @WebParam(name = "selfRegistration", partName = "addUser.selfRegistration") boolean selfRegistration)
			throws UserException, ServerException;

	@WebMethod(action = "changeUserType")
	void changeUserType(@WebParam(name = "uoid", partName = "changeUserType.uoid") long uoid, @WebParam(name = "userType", partName = "changeUserType.userType") SUserType userType)
			throws UserException, ServerException;
	...
	SProject addProjectAsSubProject(@WebParam(name = "projectName", partName = "addProjectAsSubProject.projectName") String projectName,
			@WebParam(name = "parentPoid", partName = "addProjectAsSubProject.parentPoid") long parentPoid) throws UserException, ServerException;
	...
	boolean addUserToProject(@WebParam(name = "uoid", partName = "addUserToProject.uoid") long uoid, @WebParam(name = "poid", partName = "addUserToProject.poid") long poid)
			throws UserException, ServerException;
	...
	List<SRevision> getAllRevisionsOfProject(@QueryParam("poid") @WebParam(name = "poid", partName = "getAllRevisionsOfProject.poid") long poid) throws UserException,
			ServerException;
	...
	SCompareResult compare(@WebParam(name = "roid1", partName = "compare.roid1") long roid1, @WebParam(name = "roid2", partName = "compare.roid2") long roid2,
			@WebParam(name = "sCompareType", partName = "compare.sCompareType") SCompareType sCompareType) throws UserException, ServerException;
	...
	List<SDataObject> getDataObjectsByType(@WebParam(name = "roid", partName = "getDataObjectsByType.roid") long roid,
			@WebParam(name = "className", partName = "getDataObjectsByType.className") String className) throws UserException, ServerException;

	@WebMethod(action = "getSettingsParameter")
	Object getSettingsParameter(@WebParam(name = "parameterName", partName = "getSettingsParameter.parameterName") String parameterName) throws UserException, ServerException;
	...
	void setRevisionTag(@WebParam(name = "roid", partName = "setRevisionTag.roid") long roid, @WebParam(name = "tag", partName = "setRevisionTag.tag") String tag)
			throws UserException, ServerException;
	...
	void setExportTypeEnabled(@WebParam(name = "resultType", partName = "setExportTypeEnabled.resultType") ResultType resultType, boolean enabled) throws UserException,
			ServerException;
	...
	List<SCheckout> getAllCheckoutsOfProjectAndSubProjects(@WebParam(name = "poid", partName = "getAllCheckoutsOfProjectAndSubProjects.poid") long poid) throws UserException,
			ServerException;
	...
	void validateAccount(@WebParam(name = "uoid", partName = "validateAccount.uoid") long uoid, @WebParam(name = "token", partName = "validateAccount.token") String token,
	...
	void sendClashesEmail(@WebParam(name = "sClashDetectionSettings", partName = "sendClashesEmail.sClashDetectionSettings") SClashDetectionSettings sClashDetectionSettings,
			@WebParam(name = "poid", partName = "sendClashesEmail.poid") long poid,
			@WebParam(name = "addressesTo", partName = "sendClashesEmail.addressesTo") Set<String> addressesTo) throws UserException, ServerException;
