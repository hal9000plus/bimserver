...
int __declspec(dllexport) __stdcall xxxxIsKindOf(                       //      SdaiBoolean
...
int __declspec(dllexport) __stdcall sdaiIsInstanceOf(					//		SdaiBoolean
										int		instance,				//			SdaiInstance
										int		entity					//			SdaiEntity
									);

int __declspec(dllexport) __stdcall sdaiIsInstanceOfBN(				//		SdaiBoolean
										int		instance,				//			SdaiInstance
										char	* entityName			//			SdaiString
									);

int __declspec(dllexport) __stdcall sdaiNext(							//		SdaiBoolean
										int		iterator				//			SdaiIterator
									);
...
int __declspec(dllexport) __stdcall sdaiPrevious(						//		SdaiBoolean
										int		iterator				//			SdaiIterator
									);
...
int __declspec(dllexport) __stdcall sdaiTestAttr(						//		SdaiBoolean
										int		instance,				//			SdaiInstance
										void	* attribute				//			SdaiAttr
									);

int __declspec(dllexport) __stdcall sdaiTestAttrBN(					//		SdaiBoolean
										int		instance,				//			SdaiInstance
										char	* attributeName			//			SdaiString
									);
...
int __declspec(dllexport) __stdcall sdaiIsKindOf(int instance, int entity);
