...
public class IfcEngine {
	...
	public static final String[] IFC_ENTITY_NAMES = { "Unknown", "IFCWINDOW",
			"IFCANNOTATION", "IFCBEAM", "IFCBUILDINGELEMENTCOMPONENT",
			"IFCSTRUCTURALCURVEMEMBER", "IFCSTRUCTURALSURFACEMEMBER",
			"IFCBUILDINGELEMENTPROXY", "IFCCOLUMN", "IFCCOVERING",
			"IFCCURTAINWALL", "IFCDOOR", "IFCELEMENTASSEMBLY", "IFCFASTENER",
			"IFCFOOTING", "IFCMECHANICALFASTENER", "IFCMEMBER", "IFCPILE",
			"IFCPLATE", "IFCRAILING", "IFCRAMP", "IFCRAMPFLIGHT", "IFCROOF",
			"IFCSLAB", "IFCSTAIR", "IFCSTAIRFLIGHT", "IFCSPACE", "IFCWALL",
			"IFCWALLSTANDARDCASE", "IFCAIRTERMINAL", "IFCDISTRIBUTIONELEMENT",
			"IFCENERGYCONVERSIONDEVICE", "IFCFURNISHINGELEMENT",
			"IFCFLOWCONTROLLER", "IFCFLOWFITTING", "IFCFLOWMOVINGDEVICE",
			"IFCFLOWSEGMENT", "IFCFLOWSTORAGEDEVICE", "IFCFLOWTERMINAL",
			"IFCFLOWTREATMENTDEVICE", "IFCGRID" };

	public static final String[] IFC_ENTITY_DESCRIPTIONS = { "Unknown",
			"Window", "Annotation", "Beam", "Building element component",
			"Structural curve member", "Structural surface member",
			"Building element proxy", "Column", "Covering", "Curtain wall",
			"Door", "Element assembly", "Fastener", "Footing",
			"Mechanical fastener", "Member", "Pile", "Plate", "Railing",
			"Ramp", "Ramp flight", "Roof", "Slab", "Stair", "Stair flight",
			"Space", "Wall", "Wall standard case", "Air terminal",
			"Distribution element", "Energy conversion device",
			"Furnishing element", "Flow controller", "Flow fitting",
			"Flow moving device", "Flow segment", "Flow storage device",
			"Flow terminal", "Flow treatment device", "Grid" };

	private static final String IFC_ENGINE_DLL = "IFCEngine.dll";
	private static final String IFC_ENGINE_SO = "libIfcEngineLibrary.so.1.0.0";

	// private static JNative jn = null;

	
	private static IfcEngine instance = null;
	private final String libraryPath;

	private IfcEngine(String libraryPath) {
		this.libraryPath = libraryPath;
	}

	/**
	 * Return an IFC engine object.
	 * 
	 * @return an IFC engine object.
	 */
	public static IfcEngine getInstance() {
		if (System.getProperty("os.name").startsWith("Windows")) {
			if (instance == null) {
				instance = new IfcEngine(IFC_ENGINE_DLL);
			}
		} else {
			if (instance == null) {
				instance = new IfcEngine(IFC_ENGINE_SO);
			}
		}
		return instance;
	}
	...
	public int setStringUnicode(boolean unicode) throws Exception {
		...
		if (nativeSetStringUnicode == null) {
			nativeSetStringUnicode = new JNative(libraryPath,
					"setStringUnicode");
		}
	 ...
	 * @throws Exception
	 */
	public int sdaiOpenModelBN(int repository, String fileName,
			String schemaName) throws Exception {
		int returnValue = 0;
		if (nativeSdaiOpenModelBN == null) {
			nativeSdaiOpenModelBN = new JNative(libraryPath,
					"sdaiOpenModelBN");
		}
	...
	public int sdaiCreateModelBN(int repository, String fileName,
		...
		if (nativeSdaiCreateModelBN == null) {
			nativeSdaiCreateModelBN = new JNative(libraryPath,
					"sdaiCreateModelBN");
		}
	...
	public void sdaiSaveModelBN(int repository, String fileName)
		...
		if (nativeSdaiSaveModelBN == null) {
			nativeSdaiSaveModelBN = new JNative(libraryPath,
					"sdaiSaveModelBN");
		}
	 ...
	 * @throws Exception
	 */
	public void sdaiSaveModelAsXmlBN(int model, String fileName)
			throws Exception {
		if (nativeSdaiSaveModelAsXmlBN == null) {
			nativeSdaiSaveModelAsXmlBN = new JNative(libraryPath,
	 ...
	 * @return
	 */
	public Object engiGetAggrElement(int aggregate, int elementIndex,
			int valueType) throws Exception {
		if (nativeEngiGetAggrElement == null) {
			nativeEngiGetAggrElement = new JNative(libraryPath,
					"engiGetAggrElement");
		}
	...
	private Object getReturnValue(Pointer ptr, int valueType)
	 ...
	 * @throws Exception
	 */
	public int engiGetInstanceMetaInfo(int instance, int localId,
			int className, int classNameUC) throws Exception {
		int returnValue = 0;
		if (nativeEngiGetInstanceMetaInfo == null) {
			nativeEngiGetInstanceMetaInfo = new JNative(libraryPath,
	...
	public int engiGetInstanceLocalId(int instance) throws Exception {
		...
		if (nativeEngiGetInstanceLocalId == null) {
			nativeEngiGetInstanceLocalId = new JNative(libraryPath,
					"engiGetInstanceLocalId");
		}
	...
	public String engiGetInstanceClassInfo(int instance) throws Exception {
		...
		if (nativeEngiGetInstanceClassInfo == null) {
			nativeEngiGetInstanceClassInfo = new JNative(libraryPath,
	...
	public String engiGetInstanceClassInfoUC(int instance) throws Exception {
		...
		if (nativeEngiGetInstanceClassInfoUC == null) {
			nativeEngiGetInstanceClassInfoUC = new JNative(libraryPath,
					"engiGetInstanceClassInfoUC");
		}
	 ...
	 * @param value
	 */
	public void sdaiAppend(int list, int valueType, Object value)
			throws Exception {
		...
		case sdaiLOGICAL:
			...
			break;
		case sdaiREAL:
			nativeSdaiAppend.setParameter(2, Type.DOUBLE, ((Double) value)
					.toString());
			break;
		case sdaiSTRING:
	...
	public int sdaiCreateADB(int valueType, Object value) throws Exception {
		...
		case sdaiLOGICAL:
			...
			break;
		case sdaiREAL:
			nativeSdaiCreateADB.setParameter(1, Type.DOUBLE, ((Double) value)
					.toString());
			break;
		case sdaiSTRING:
	 ...
	 * @throws Exception
	 */
	public int sdaiCreateAggrBN(int instance, String attributeName)
			throws Exception {
		int returnValue = 0;
		if (nativeSdaiCreateAggrBN == null) {
			nativeSdaiCreateAggrBN = new JNative(libraryPath,
					"sdaiCreateAggrBN");
		}
	...
	public int sdaiCreateInstance(int model, int entity) throws Exception {
		...
		if (nativeSdaiCreateInstance == null) {
			nativeSdaiCreateInstance = new JNative(libraryPath,
					"sdaiCreateInstance");
		}
	 ...
	 * @throws Exception
	 */
	public int sdaiCreateInstanceBN(int model, String entityName)
			throws Exception {
		int returnValue = 0;
		if (nativeSdaiCreateInstanceBN == null) {
			nativeSdaiCreateInstanceBN = new JNative(libraryPath,
	 ...
	 * @throws Exception
	 */
	public int sdaiCreateInstanceBNEI(int model, String entityName,
			int express_id) throws Exception {
		int returnValue = 0;
		if (nativeSdaiCreateInstanceBNEI == null) {
			nativeSdaiCreateInstanceBNEI = new JNative(libraryPath,
	...
	public int sdaiCreateIterator(int aggregate) throws Exception {
		...
		if (nativeSdaiCreateIterator == null) {
			nativeSdaiCreateIterator = new JNative(libraryPath,
					"sdaiCreateIterator");
		}
	...
	public void sdaiDeleteInstance(int instance) throws Exception {
		if (nativeSdaiDeleteInstance == null) {
			nativeSdaiDeleteInstance = new JNative(libraryPath,
					"sdaiDeleteInstance");
		}
	...
	public void sdaiDeleteIterator(int iterator) throws Exception {
		if (nativeSdaiDeleteIterator == null) {
			nativeSdaiDeleteIterator = new JNative(libraryPath,
					"sdaiDeleteIterator");
		}
	 ...
	 * @throws Exception
	 */
	public Object sdaiGetAggrByIterator(int iterator, int valueType)
			throws Exception {
		if (nativeSdaiGetAggrByIterator == null) {
			nativeSdaiGetAggrByIterator = new JNative(libraryPath,
	 ...
	 * @throws Exception
	 */
	public Object sdaiGetAttr(int instance, int attribute, int valueType)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public Object sdaiGetAttrBN(int instance, String attributeName,
			int valueType) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int sdaiGetAttrDefinition(int entity, String attributeName)
			throws Exception {
		int returnValue = 0;
		if (nativeSdaiGetAttrDefinition == null) {
			nativeSdaiGetAttrDefinition = new JNative(libraryPath,
	...
	public int sdaiGetEntityExtent(int model, int entity) throws Exception {
		...
		if (nativeSdaiGetEntityExtent == null) {
			nativeSdaiGetEntityExtent = new JNative(libraryPath,
					"sdaiGetEntityExtent");
		}
	 ...
	 * @throws Exception
	 */
	public int sdaiGetEntityExtentBN(int model, String entityName)
			throws Exception {
		int returnValue = 0;
		if (nativeSdaiGetEntityExtentBN == null) {
			nativeSdaiGetEntityExtentBN = new JNative(libraryPath,
	...
	public int sdaiGetInstanceType(int instance) throws Exception {
		...
		if (nativeSdaiGetInstanceType == null) {
			nativeSdaiGetInstanceType = new JNative(libraryPath,
					"sdaiGetInstanceType");
		}
	...
	public int sdaiGetMemberCount(int aggregate) throws Exception {
		...
		if (nativeSdaiGetMemberCount == null) {
			nativeSdaiGetMemberCount = new JNative(libraryPath,
					"sdaiGetMemberCount");
		}
	...
	public boolean sdaiIsInstanceOf(int instance, int entity) throws Exception {
		...
		if (nativeSdaiIsInstanceOf == null) {
			nativeSdaiIsInstanceOf = new JNative(libraryPath,
					"sdaiIsInstanceOf");
		}
		...
		returnValue = nativeSdaiIsInstanceOf.getRetValAsInt() == 0 ? false
				: true;
		return returnValue;
	 ...
	 * @throws Exception
	 */
	public boolean sdaiIsInstanceOfBN(int instance, String entityName)
			throws Exception {
		boolean returnValue = false;
		if (nativeSdaiIsInstanceOfBN == null) {
			nativeSdaiIsInstanceOfBN = new JNative(libraryPath,
					"sdaiIsInstanceOfBN");
		}
		...
		returnValue = nativeSdaiIsInstanceOfBN.getRetValAsInt() == 0 ? false
				: true;
		return returnValue;
	 ...
	 * @throws Exception
	 */
	public void sdaiPrepend(int list, int valueType, Object value)
			throws Exception {
		...
		case sdaiLOGICAL:
			...
			break;
		case sdaiREAL:
			nativeSdaiPrepend.setParameter(2, Type.DOUBLE, ((Double) value)
					.toString());
			break;
		case sdaiSTRING:
	 ...
	 * @throws Exception
	 */
	public void sdaiPutADBTypePath(int ADB, int pathCount, String path)
			throws Exception {
		if (nativeSdaiPutADBTypePath == null) {
			nativeSdaiPutADBTypePath = new JNative(libraryPath,
					"sdaiPutADBTypePath");
		}
	...
	public void sdaiPutAggrByIterator(int iterator, int valueType, Object value)
			throws Exception {
		if (nativeSdaiPutAggrByIterator == null) {
			nativeSdaiPutAggrByIterator = new JNative(libraryPath,
		...
		switch (valueType) {
		case sdaiADB:
			nativeSdaiPutAggrByIterator.setParameter(2, ((Integer) value)
					.intValue());
			break;
		case sdaiAGGR:
			nativeSdaiPutAggrByIterator.setParameter(2, ((Integer) value)
		...
		case sdaiLOGICAL:
			...
			break;
		case sdaiREAL:
			nativeSdaiPutAggrByIterator.setParameter(2, Type.DOUBLE,
					((Double) value).toString());
			break;
		case sdaiSTRING:
			nativeSdaiPutAggrByIterator.setParameter(2, Type.STRING,
					(String) value);
			break;
		}
	 ...
	 * @throws Exception
	 */
	public void sdaiPutAttr(int instance, int attribute, int valueType,
		...
		case sdaiLOGICAL:
			...
			break;
		case sdaiREAL:
			nativeSdaiPutAttr.setParameter(3, Type.DOUBLE, ((Double) value)
					.toString());
			break;
		case sdaiSTRING:
	 ...
	 * @throws Exception
	 */
	public void sdaiPutAttrBN(int instance, String attributeName,
			int valueType, Object value) throws Exception {
		...
		case sdaiLOGICAL:
			...
			break;
		case sdaiREAL:
			nativeSdaiPutAttrBN.setParameter(3, Type.DOUBLE, ((Double) value)
					.toString());
			break;
		case sdaiSTRING:
	 ...
	 * @throws Exception
	 */
	public boolean sdaiTestAttrBN(int instance, String attributeName)
			throws Exception {
		boolean returnValue = false;
	...
	public class SurfaceProperties {
		...
		public SurfaceProperties(int model, int noVertices, int noIndices,
				double scale) {
			this.model = model;
		...
		public SurfaceProperties(int model, int instance, int noVertices,
				int noIndices, double scale) {
			this(model, noVertices, noIndices, scale);
			this.instance = instance;
		}

		public SurfaceProperties(int model, int instance, int instanceList,
	 ...
	 */
	public SurfaceProperties initializeModelling(int model, double scale)
			throws Exception {
		if (nativeInitializeModelling == null) {
			nativeInitializeModelling = new JNative(libraryPath,
					"initializeModelling");
		}
		...
		nativeInitializeModelling.setParameter(3, Type.DOUBLE, Double
				.toString(scale));
	 ...
	 * @throws Exception
	 */
	public SurfaceProperties initializeModellingInstance(int model,
			double scale, int instance) throws Exception {
		if (nativeInitializeModellingInstance == null) {
			nativeInitializeModellingInstance = new JNative(libraryPath,
		...
		nativeInitializeModellingInstance.setParameter(3, Type.DOUBLE, Double
				.toString(scale));
	 ...
	 * @throws Exception
	 */
	public SurfaceProperties initializeModellingInstanceEx(int model,
			double scale, int instance, int instanceList) throws Exception {
		if (nativeInitializeModellingInstanceEx == null) {
			nativeInitializeModellingInstanceEx = new JNative(libraryPath,
					"initializeModellingInstanceEx");
		}
		...
		nativeInitializeModellingInstanceEx.setParameter(3, Type.DOUBLE, Double
				.toString(scale));
	 ...
	 * @throws Exception
	 */
	public int finalizeModelling(int model, float[] coordinates,
			float[] normals, int[] indices) throws Exception {
		int fvf = 0;
		int size = 0;
		int noVertices = 0;
		int noIndices = 0;
		...
		if (nativeFinalizeModelling == null) {
			nativeFinalizeModelling = new JNative(libraryPath,
					"finalizeModelling");
		}
	...
	public class InstanceVisualisationProperties {
	 ...
	 * @throws Exception
	 */
	public InstanceVisualisationProperties getInstanceInModelling(int model,
			int instance, int mode) throws Exception {
		if (nativeGetInstanceInModelling == null) {
			nativeGetInstanceInModelling = new JNative(libraryPath,
	...
	public class InstanceDerivedProperties {
		...
		public InstanceDerivedProperties(int model, int instance,
	...
	public InstanceDerivedProperties getInstanceDerivedPropertiesInModelling(
			int model, int instance) throws Exception {
		if (nativeGetInstanceDerivedPropertiesInModelling == null) {
			nativeGetInstanceDerivedPropertiesInModelling = new JNative(
					libraryPath, "getInstanceDerivedPropertiesInModelling");
		}
	...
	public class InstanceDerivedBoundingBox {
		...
		public InstanceDerivedBoundingBox(int model, int instance, double ox,
				double oy, double oz, double vx, double vy, double vz) {
			this.model = model;
			this.instance = instance;
			this.ox = ox;
			this.oy = oy;
	 ...
	 * @throws Exception
	 */
	public InstanceDerivedBoundingBox getInstanceDerivedBoundingBox(int model,
			int instance) throws Exception {
		if (nativeGetInstanceDerivedBoundingBox == null) {
			nativeGetInstanceDerivedBoundingBox = new JNative(libraryPath,
	...
	public class InstanceDerivedTransformationMatrix {
		...
		public InstanceDerivedTransformationMatrix(int model, int instance,
				double _11, double _12, double _13, double _14, double _21,
				double _22, double _23, double _24, double _31, double _32,
				double _33, double _34, double _41, double _42, double _43,
				double _44) {
			this.model = model;
			this.instance = instance;
			this._11 = _11;
	...
	public InstanceDerivedTransformationMatrix getInstanceDerivedTransformationMatrix(
		...
		if (nativeGetInstanceDerivedTransformationMatrix == null) {
			nativeGetInstanceDerivedTransformationMatrix = new JNative(
					libraryPath, "getInstanceDerivedTransformationMatrix");
		}
	 ...
	 * @throws Exception
	 */
	public void setChangedData(int model, int timeStamp, String changedData)
			throws Exception {
	...
	public int internalGetBoundingBox(int model, int instance) throws Exception {
		...
		if (nativeInternalGetBoundingBox == null) {
			nativeInternalGetBoundingBox = new JNative(libraryPath,
	...
	public int internalGetCenter(int model, int instance) throws Exception {
		...
		if (nativeInternalGetCenter == null) {
			nativeInternalGetCenter = new JNative(libraryPath,
					"internalGetCenter");
		}
	 ...
	 * @throws Exception
	 */
	public void internalSetLink(int instance, String attributeName,
			int linked_id) throws Exception {
		if (nativeInternalSetLink == null) {
			nativeInternalSetLink = new JNative(libraryPath,
					"internalSetLink");
		}
	...
	public void internalAddAggrLink(int list, int linked_id) throws Exception {
		if (nativeInternalAddAggrLink == null) {
			nativeInternalAddAggrLink = new JNative(libraryPath,
					"internalAddAggrLink");
		}
	 ...
	 * @throws Exception
	 */
	public String sdaiGetStringAttrBN(int instance, String attributeName)
			throws Exception {
		if (nativeSdaiGetStringAttrBN == null) {
			nativeSdaiGetStringAttrBN = new JNative(libraryPath,
					"sdaiGetStringAttrBN");
		}
	 ...
	 * @throws Exception
	 */
	public int sdaiGetInstanceAttrBN(int instance, String attributeName)
			throws Exception {
		int returnValue = 0;
		if (nativeSdaiGetInstanceAttrBN == null) {
			nativeSdaiGetInstanceAttrBN = new JNative(libraryPath,
	 ...
	 * @throws Exception
	 */
	public int sdaiGetAggregationAttrBN(int instance, String attributeName)
			throws Exception {
		int returnValue = 0;
		if (nativeSdaiGetAggregationAttrBN == null) {
			nativeSdaiGetAggregationAttrBN = new JNative(libraryPath,
		...
		nativeSdaiGetAggregationAttrBN.setParameter(1, Type.STRING,
				attributeName);
	...
	public static void main(String[] args) throws Exception {
		IfcEngine engine = IfcEngine.getInstance();

		int modelID = engine.sdaiOpenModelBN(1, "house.ifc",
				"lib\\IFC2x3_Final.exp");
		System.out.println("sdaiOpenModelBN: modelID=0x"
				+ String.format("%1$x", modelID));

		// SurfaceProperties sp = engine.initializeModelling(modelID, 0.0);
		// float[] vertices = new float[sp.getVerticesCount() * 3];
		// float[] normals = new float[sp.getVerticesCount() * 3];
		// int[] indices = new int[sp.getIndicesCount()];
		// engine.finalizeModelling(modelID, vertices, normals, indices);

		// for (int i = 0; i < sp.getVerticesCount() * 3; i += 3) {
		// System.out.print(vertices[i] + " " + vertices[i + 1] + " "
		// + vertices[i + 2] + " " + normals[i] + " " + normals[i + 1]
		// + " " + normals[i + 2]);
		// System.out.println();
		// }

		// int aggregateID = engine.sdaiGetEntityExtentBN(modelID,
		// "IFCCARTESIANPOINT");
		// int objectCount = engine.sdaiGetMemberCount(aggregateID);
		// for (int elementIndex = 0; elementIndex < objectCount;
		// elementIndex++) {
		// int objectID = (Integer) engine.engiGetAggrElement(aggregateID,
		// elementIndex, sdaiINSTANCE);
		// int coordinates = (Integer) engine.sdaiGetAttrBN(objectID,
		// "Coordinates", sdaiAGGR);
		// if (coordinates > 0) {
		// int coordinatesCount = engine.sdaiGetMemberCount(coordinates);
		// for (int index = 0; index < coordinatesCount; index++) {
		// Object obj = engine.engiGetAggrElement(coordinates, index,
		// sdaiREAL);
		// float x = obj != null ? (Float) obj : 0.0f;
		// System.out.print(" " + x);
		// }
		// System.out.println();
		// }
		...
		for (int entityIndex = 1; entityIndex < IFC_ENTITY_NAMES.length; entityIndex++) {
			int aggregateID = engine.sdaiGetEntityExtentBN(modelID,
					IFC_ENTITY_NAMES[entityIndex]);
			int objectCount = engine.sdaiGetMemberCount(aggregateID);
			for (int elementIndex = 0; elementIndex < objectCount; elementIndex++) {
				int objectID = (Integer) engine.engiGetAggrElement(aggregateID,
						elementIndex, sdaiINSTANCE);
				System.out.println(IFC_ENTITY_NAMES[entityIndex]
						+ " "
						+ (String) engine.sdaiGetAttrBN(objectID, "GlobalId",
								sdaiSTRING));

				// InstanceDerivedBoundingBox bb = engine
				// .getInstanceDerivedBoundingBox(modelID, objectID);

				int placement = (Integer) engine.sdaiGetAttrBN(objectID,
						"ObjectPlacement", sdaiINSTANCE);
				if (placement > 0) {
					System.out.println("Placement="
							+ engine.engiGetInstanceClassInfo(placement));
					int placementRelTo = (Integer) engine.sdaiGetAttrBN(
							placement, "PlacementRelTo", sdaiINSTANCE);
					if (placementRelTo > 0) {
						System.out
								.println("\tPlacementRelTo="
										+ engine
												.engiGetInstanceClassInfo(placementRelTo));
					}
					int relativePlacement = (Integer) engine.sdaiGetAttrBN(
							placement, "RelativePlacement", sdaiINSTANCE);
					if (relativePlacement > 0) {
						System.out
								.println("\tRelativePlacement="
										+ engine
												.engiGetInstanceClassInfo(relativePlacement));
						int location = (Integer) engine.sdaiGetAttrBN(
								relativePlacement, "Location", sdaiINSTANCE);
						if (location > 0) {
							System.out
									.print("\t\tLocation="
											+ engine
													.engiGetInstanceClassInfo(location));
							int coordinates = (Integer) engine.sdaiGetAttrBN(
									location, "Coordinates", sdaiAGGR);
							if (coordinates > 0) {
								int coordinatesCount = engine
										.sdaiGetMemberCount(coordinates);
								for (int index = 0; index < coordinatesCount; index++) {
									System.out.print(" "
						...
						int axis = (Integer) engine.sdaiGetAttrBN(
								relativePlacement, "Axis", sdaiINSTANCE);
						if (axis > 0) {
							System.out.print("\t\tAxis="
									+ engine.engiGetInstanceClassInfo(axis));
							int directionRatios = (Integer) engine
									.sdaiGetAttrBN(axis, "DirectionRatios",
											sdaiAGGR);
							if (directionRatios > 0) {
								int directionRatiosCount = engine
										.sdaiGetMemberCount(directionRatios);
								for (int index = 0; index < directionRatiosCount; index++) {
									System.out.print(" "
											+ engine.engiGetAggrElement(
													directionRatios, index,
													sdaiREAL));
								}
							}
							System.out.println();
						}
						int refDirection = (Integer) engine
								.sdaiGetAttrBN(relativePlacement,
										"RefDirection", sdaiINSTANCE);
						if (refDirection > 0) {
							System.out
									.print("\t\tRefDirection="
											+ engine
													.engiGetInstanceClassInfo(refDirection));
							int directionRatios = (Integer) engine
									.sdaiGetAttrBN(refDirection,
											"DirectionRatios", sdaiAGGR);
							if (directionRatios > 0) {
								int directionRatiosCount = engine
										.sdaiGetMemberCount(directionRatios);
								for (int index = 0; index < directionRatiosCount; index++) {
		...
		// int relPropSetAggr = engine.sdaiGetEntityExtentBN(modelID,
		// "IFCRELDEFINESBYPROPERTIES");
		// int relPropSetCnt = engine.sdaiGetMemberCount(relPropSetAggr);
		// for (int index = 0; index < relPropSetCnt; index++) {
		// Integer relPropSetID = (Integer) engine.engiGetAggrElement(
		// relPropSetAggr, index, sdaiINSTANCE);
		// Integer relObjAggr = (Integer) engine.sdaiGetAttrBN(relPropSetID,
		// "RelatedObjects", sdaiAGGR);
		// int relObjCnt = engine.sdaiGetMemberCount(relObjAggr);
		// System.out.print("(");
		// for (int i = 0; i < relObjCnt; i++) {
		// Integer relObjID = (Integer) engine.engiGetAggrElement(
		// relObjAggr, i, sdaiINSTANCE);
		// System.out.print(engine.sdaiGetAttrBN(relObjID, "Name",
		// sdaiSTRING));
		// if (i < relObjCnt - 1)
		// System.out.print(",");
		// }
		// System.out.println(")");
		// int propDefID = (Integer) engine.sdaiGetAttrBN(relPropSetID,
		// "RelatingPropertyDefinition", sdaiINSTANCE);
		// System.out.println("*** "
		// + engine.engiGetInstanceClassInfo(propDefID) + " ***");
		// if (engine.engiGetInstanceClassInfo(propDefID).equals(
		// "IfcPropertySet")) {
		// System.out.println("IFCPROPERTYSET \""
		// + (String) engine.sdaiGetAttrBN(propDefID, "Name",
		// sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(propDefID,
		// "Description", sdaiSTRING) + "\"");
		//
		// int propAggr = (Integer) engine.sdaiGetAttrBN(propDefID,
		// "HasProperties", sdaiAGGR);
		// int propCnt = engine.sdaiGetMemberCount(propAggr);
		// for (int propIndex = 0; propIndex < propCnt; propIndex++) {
		// Integer propID = (Integer) engine.engiGetAggrElement(
		// propAggr, propIndex, sdaiINSTANCE);
		// if (engine.sdaiIsInstanceOfBN(propID, "IFCCOMPLEXPROPERTY")) {
		// System.out.println("\t\""
		// + (String) engine.sdaiGetAttrBN(propID, "Name",
		// sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(propID,
		// "UsageName", sdaiSTRING) + "\"");
		// Integer subpropAggr = (Integer) engine.sdaiGetAttrBN(
		// propID, "HasProperties", sdaiAGGR);
		// int subpropCnt = engine.sdaiGetMemberCount(subpropAggr);
		// for (int subpropIndex = 0; subpropIndex < subpropCnt; subpropIndex++)
		// {
		// Integer subpropID = (Integer) engine
		// .engiGetAggrElement(subpropAggr,
		// subpropIndex, sdaiINSTANCE);
		// int x = (Integer) engine.sdaiGetInstanceAttrBN(subpropID,
		// "NominalValue");
		// String y = engine
		// .engiGetInstanceClassInfo(subpropID);
		// System.out.println("\t\t\""
		// + (String) engine.sdaiGetAttrBN(subpropID,
		// "Name", sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(subpropID,
		// "Description", sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(subpropID,
		// "NominalValue", sdaiSTRING)
		// + "\" "
		// + (Integer) engine.sdaiGetAttrBN(subpropID,
		// "Unit", sdaiENUM));
		// }
		// } else
		// System.out.println("\t\""
		...
		// "NominalValue", sdaiSTRING)
		// + "\" "
		// + (Integer) engine.sdaiGetAttrBN(propID,
		// "Unit", sdaiENUM));
		// }
		// } else if (engine.engiGetInstanceClassInfo(propDefID).equals(
		// "IfcElementQuantity")) {
		// System.out.println("IFCELEMENTQUANTITY \""
		// + (String) engine.sdaiGetAttrBN(propDefID, "Name",
		// sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(propDefID,
		...
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(propDefID,
		// "MethodOfMeasurement", sdaiSTRING));
		// Integer quantitiesAggr = (Integer) engine.sdaiGetAttrBN(
		// propDefID, "Quantities", sdaiAGGR);
		// int quantitiesCnt = engine.sdaiGetMemberCount(quantitiesAggr);
		// for (int qIndex = 0; qIndex < quantitiesCnt; qIndex++) {
		// Integer quantityID = (Integer) engine.engiGetAggrElement(
		// quantitiesAggr, qIndex, sdaiINSTANCE);
		// System.out.println("\t\t\""
		// + (String) engine.sdaiGetAttrBN(quantityID, "Name",
		// sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(quantityID,
		// "Description", sdaiSTRING)
		// + "\" \""
		// + (String) engine.sdaiGetAttrBN(quantityID,
		// "NominalValue", sdaiSTRING)
		// + "\" "
		// + (Integer) engine.sdaiGetAttrBN(quantityID,
		// "Unit", sdaiENUM));
		// }
		// } else {
