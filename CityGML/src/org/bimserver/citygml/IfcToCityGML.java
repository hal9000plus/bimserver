...
public class IfcToCityGML extends BimModelSerializer {
	...
	public IfcToCityGML(EmfModel<Long> emfModel, SchemaDefinition schemaDefinition, FieldIgnoreMap fieldIgnoreMap, FailSafeIfcEngine ifcEngine) {
		super(emfModel, fieldIgnoreMap);
	...
	public void write(OutputStream out) throws SerializerException {
