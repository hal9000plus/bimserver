...
%>
	</select> <label for="zip_<%=revision.getId() %>">Zip</label><input type="checkbox" name="zip" id="zip_<%=revision.getId() %>"/> <input type="submit" value="Download"></td>
</table>
</form>
<form action="<%=request.getContextPath() %>/download" method="post">
<input type="hidden" name="pid" value="<%=pid %>"/>
...
%>
	</select> <label for="zip_<%=revision.getId() %>">Zip</label><input type="checkbox" name="zip" id="zip_<%=revision.getId() %>"/> <input type="submit" value="Checkout">
</table>
</form>
</div>
...
<%
	for (ResultType resultType : EmfSerializerFactory.getInstance().getSingleResultTypes()) {
%>
	<option value="<%=resultType.name() %>"><%= resultType.name() %></option>
<%	
	}
%>
	</select></td><td> <label for="zip_<%=revision.getId() %>">Zip</label><input type="checkbox" name="zip" id="zip_<%=revision.getId() %>"/> <input type="submit" value="Query"></td>
</tr>
</table>
</form>
<form action="<%=request.getContextPath() %>/download" method="post">
...
%>
	</select> <label for="zip_<%=checkout.getId() %>">Zip</label><input type="checkbox" name="zip" id="zip_<%=checkout.getId() %>"/> <input type="submit" value="Download"/>
	</form>
	</td>
	<td>
	<form method="post" action="<%=request.getContextPath() %>/download">
...
%>
	</select> <label for="zip_<%=checkout.getId() %>">Zip</label><input type="checkbox" name="zip" id="zip_<%=checkout.getId() %>"/> <input type="submit" value="Checkout"/>
	</form>
	</td>
</tr>
<%
